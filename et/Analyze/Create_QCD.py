if __name__ == "__main__":
    ...
    fout.cd()
    dir0jet1=fout.mkdir("et_0jet_low")
    dir0jet1.cd()
    hSS_0jet1.Write()

    dir0jet2=fout.mkdir("et_0jet_high")
    dir0jet2.cd()
    hSS_0jet2.Write()

    dir1jet1=fout.mkdir("et_1jet_low")
    dir1jet1.cd()
    hSS_1jet1.Write()

    dir1jet2=fout.mkdir("et_1jet_high")
    dir1jet2.cd()
    hSS_1jet2.Write()

    dir2jet1=fout.mkdir("et_vbf_low")
    dir2jet1.cd()
    hSS_2jet1.Write()

    dir2jet2=fout.mkdir("et_vbf_high")
    dir2jet2.cd()
    hSS_2jet2.Write()
