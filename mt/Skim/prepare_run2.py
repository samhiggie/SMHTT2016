...
if __name__ == "__main__":
    ...
    #sample=["data_SingleMuon_Run2016B/","data_SingleMuon_Run2016C/","data_SingleMuon_Run2016D/","data_SingleMuon_Run2016E/","data_SingleMuon_Run2016F/"]
    ...
    datadir="/nfs_scratch/caillol/mutau_sv/"
    ...
    for j in range(0,len(name)):
	   ...
	   command1=command1+"./skim_mt.exe mc "+datadir+"Out_"+name[j]+"/"+name[j]+str(ligne)+".root " + i[0:-1] +"\n"
           ligne=ligne+1
