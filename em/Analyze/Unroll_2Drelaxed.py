...
file=ROOT.TFile("final_emu_2D.root","r")
file1D=ROOT.TFile("final_emu_1D.root","recreate")

adapt=ROOT.gROOT.GetColor(12)
new_idx=ROOT.gROOT.GetListOfColors().GetSize() + 1
trans=ROOT.TColor(new_idx, adapt.GetRed(), adapt.GetGreen(),adapt.GetBlue(), "",0.5)

categories=["em_0jet","em_1jet","em_vbf"] 
cat=["em_0jet","em_1jet","em_vbf"]
ncat=3
...
for i in range (0,ncat):
   ...
   QCD2D_d=file.Get(categories[i]).Get("QCD_EESDown")
   W2D_d=file.Get(categories[i]).Get("W_EESDown")
   TT2D_d=file.Get(categories[i]).Get("TT_EESDown")
   VV2D_d=file.Get(categories[i]).Get("VV_EESDown")
   DYB2D_d=file.Get(categories[i]).Get("ZL_EESDown")
   DYS2D_d=file.Get(categories[i]).Get("ZTT_EESDown")
   qqH2D_d=file.Get(categories[i]).Get("qqH125_EESDown")
   ggh2D_d=file.Get(categories[i]).Get("ggH125_EESDown")
   qqH1302D_d=file.Get(categories[i]).Get("qqH130_EESDown")
   ggh1302D_d=file.Get(categories[i]).Get("ggH130_EESDown")
   qqH1202D_d=file.Get(categories[i]).Get("qqH120_EESDown")
   ggh1202D_d=file.Get(categories[i]).Get("ggH120_EESDown")

   QCD2D_u=file.Get(categories[i]).Get("QCD_EESUp")
   W2D_u=file.Get(categories[i]).Get("W_EESUp")
   TT2D_u=file.Get(categories[i]).Get("TT_EESUp")
   VV2D_u=file.Get(categories[i]).Get("VV_EESUp")
   DYB2D_u=file.Get(categories[i]).Get("ZL_EESUp")
   DYS2D_u=file.Get(categories[i]).Get("ZTT_EESUp")
   qqH2D_u=file.Get(categories[i]).Get("qqH125_EESUp")
   ggh2D_u=file.Get(categories[i]).Get("ggH125_EESUp")
   qqH1302D_u=file.Get(categories[i]).Get("qqH130_EESUp")
   ggh1302D_u=file.Get(categories[i]).Get("ggH130_EESUp")
   qqH1202D_u=file.Get(categories[i]).Get("qqH120_EESUp")
   ggh1202D_u=file.Get(categories[i]).Get("ggH120_EESUp")
   ...
   QCD_u=ROOT.TH1F("QCD_EESUp","QCD_EESUp",nx*ny,0,nx*ny)
   W_u=ROOT.TH1F("W_EESUp","W_EESUp",nx*ny,0,nx*ny)
   TT_u=ROOT.TH1F("TT_EESUp","TT_EESUp",nx*ny,0,nx*ny)
   VV_u=ROOT.TH1F("VV_EESUp","VV_EESUp",nx*ny,0,nx*ny)
   DYB_u=ROOT.TH1F("ZL_EESUp","ZL_EESUp",nx*ny,0,nx*ny)
   DYS_u=ROOT.TH1F("ZTT_EESUp","ZTT_EESUp",nx*ny,0,nx*ny)
   qqH_u=ROOT.TH1F("qqH125_EESUp","qqH125_EESUp",nx*ny,0,nx*ny)
   ggh_u=ROOT.TH1F("ggH125_EESUp","ggH125_EESUp",nx*ny,0,nx*ny)
   qqH120_u=ROOT.TH1F("qqH120_EESUp","qqH120_EESUp",nx*ny,0,nx*ny)
   ggh120_u=ROOT.TH1F("ggH120_EESUp","ggH120_EESUp",nx*ny,0,nx*ny)
   qqH130_u=ROOT.TH1F("qqH130_EESUp","qqH130_EESUp",nx*ny,0,nx*ny)
   ggh130_u=ROOT.TH1F("ggH130_EESUp","ggH130_EESUp",nx*ny,0,nx*ny)

   QCD_d=ROOT.TH1F("QCD_EESDown","QCD_EESDown",nx*ny,0,nx*ny)
   W_d=ROOT.TH1F("W_EESDown","W_EESDown",nx*ny,0,nx*ny)
   TT_d=ROOT.TH1F("TT_EESDown","TT_EESDown",nx*ny,0,nx*ny)
   VV_d=ROOT.TH1F("VV_EESDown","VV_EESDown",nx*ny,0,nx*ny)
   DYB_d=ROOT.TH1F("ZL_EESDown","ZL_EESDown",nx*ny,0,nx*ny)
   DYS_d=ROOT.TH1F("ZTT_EESDown","ZTT_EESDown",nx*ny,0,nx*ny)
   qqH_d=ROOT.TH1F("qqH125_EESDown","qqH125_EESDown",nx*ny,0,nx*ny)
   ggh_d=ROOT.TH1F("ggH125_EESDown","ggH125_EESDown",nx*ny,0,nx*ny)
   qqH120_d=ROOT.TH1F("qqH120_EESDown","qqH120_EESDown",nx*ny,0,nx*ny)
   ggh120_d=ROOT.TH1F("ggH120_EESDown","ggH120_EESDown",nx*ny,0,nx*ny)
   qqH130_d=ROOT.TH1F("qqH130_EESDown","qqH130_EESDown",nx*ny,0,nx*ny)
   ggh130_d=ROOT.TH1F("ggH130_EESDown","ggH130_EESDown",nx*ny,0,nx*ny)
   ...
   for z in range(1,nx+1):
      ...
      if i==0:
         label[z-1].AddText("p_{T}(#mu) > "+str(tauptbins[z-1])+" GeV")
      if i==1:
