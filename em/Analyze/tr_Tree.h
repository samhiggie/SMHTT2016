  float photonIso_2, puIso_2, chargedIso_2, neutralIso_2,m_sv,m_sv_UP,m_sv_DOWN,metcor,metcorphi,met_sv_UP,met_sv_DOWN, pt_sv, pt_sv_DOWN, pt_sv_UP,met_sv;
  ...
  bool isZem,isZtt;
  int nbtag;
  float gentau_vispt, passE23Mu8, passMu23E12, iso_2, pt_top1, pt_top2;
